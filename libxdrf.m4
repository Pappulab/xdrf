...
/* By setting the xdridptr to 21 we reserve the position at
   point 20 as a binary value to set if the xdrid structure
   was generated by a FORTRAN call (in which case libxdrf must
   free the memory) or a C call (in which case the calling
   program is responsible for memory freeing
*/
